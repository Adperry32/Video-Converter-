...
# Function to handle the download and conversion process
...
# Download button
download_button = tk.Button(root, text="Download", command=download_and_convert, bg="blue", fg="white", font=("Arial", 12))
